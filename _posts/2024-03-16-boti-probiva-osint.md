...
[@CyberSecBot](/CyberSecBot/) — бесплатный OSINT бот, собирающий данные из открытых источников. Он предоставляет информацию о телефонных номерах, ID Telegram, анализирует сообщения пользователей, отслеживает IP-адреса, профили ВКонтакте и многое другое.

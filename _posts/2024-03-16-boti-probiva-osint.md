...
[@PasswordSearch](https://t.me/PasswordSearchBot) — обнаружит пароли, если ваш или любой другой email попал в утечку данных. Десять раз чекнуть можно бесплатно.
...
[@Getairplane](https://t.me/getairplane_bot) — получите три бесплатных запроса на информацию о перелетах за последние 20 лет по номеру телефона.

[@clerkinfobot](https://t.me/clerksecretbot) — поиск по номеру телефона и username Telegram. В боте встроен функционал поиска по автовладельцам надет ФИО, VIN, CNC, марку, ОСАГО.

[@MsisdnInfoBot](https://bit.ly/3W70ZAI) — поможет вам определить регион и оператора для любого номера телефона бесплатно.

[@bmi\_np\_bot](https://bit.ly/3Y6X60Y) — бот для определения оператора и других данных по номеру телефона. Похож на бот, указанный выше, и также является бесплатным, но менее функциональным.

...
[@VKHistoryRobot](https://t.me/VKHistoryRobot) — отслеживает изменения фамилий в профилях и показывает дату создания аккаунта.

[@VKFindName](https://t.me/FindNameVk_bot) — Покажет как профиль ВКонтакте выглядел в прошлом (бесплатно).
...
[@Carscan](https://bit.ly/3y3Cexi) — Данный бот создан для поиска информации о авто из РФ. Находит VIN, модель, марку и СТС.

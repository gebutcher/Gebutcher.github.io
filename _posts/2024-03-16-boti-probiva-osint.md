...
[@MsisdnInfoBot](https://ok.me/QZrG1) — поможет вам определить регион и оператора для любого номера телефона бесплатно.

[@bmi\_np\_bot](https://ok.me/xCpG1) — бот для определения оператора и других данных по номеру телефона. Похож на бот, указанный выше, и также является бесплатным, но менее функциональным.
...
[@vkfindfaces](https://ok.me/zO8G1) — Бот для поиска профиля человека Вконтакте по его фото.

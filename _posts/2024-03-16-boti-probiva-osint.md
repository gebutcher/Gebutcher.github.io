...
[@telesint_bot](/telesintbots/) — позволяет узнать, в каких публичных чатах состоит пользователь. Сейчас в базе данных бота находится более двух миллионов публичных чатов и записи о более чем 366+ миллионах пользователей.

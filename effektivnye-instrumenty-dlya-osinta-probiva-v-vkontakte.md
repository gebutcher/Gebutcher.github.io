# Эффективные инструменты для OSINTа / пробива в ВКонтакте

<figure><img src=".gitbook/assets/vk.png" alt=""><figcaption></figcaption></figure>
...
* [HiddenFriends](https://vk.com/app3256362) — поможет вам найти скрытых друзей в вашем списке контактов.
